        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="space-y-6">
              ...
              <a href="https://wa.me/905432357786" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 p-5 bg-gray-50 rounded-lg hover:bg-green-50 transition-colors group">
