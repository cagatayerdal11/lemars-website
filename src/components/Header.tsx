        ...
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5 ml-1">
              ...
              <a href="https://wa.me/905432357786" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 transition-colors" aria-label="WhatsApp">
